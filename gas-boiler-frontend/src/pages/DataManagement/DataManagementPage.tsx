...
const DataManagementPage: React.FC = () => {
  ...
  const handleSaveInterval = async () => {
    ...
    try {
      ...
      setSettings(updated);
      setIntervalMessage(
        `✅ Recording interval updated to ${selectedInterval} minutes`,
      );
        ...
        <div className="data-management-card">
          <div className="page-header">
            ...
            <p className="page-description">
              Manage background recording service, historical data, and data
              operations
            </p>
          </div>
          ...
          <div className="management-section recording-section">
            ...
            <p className="section-description">
              Configure how often the system automatically records building
              data. Changes apply immediately - no restart required!
            </p>
            ...
            <div className="interval-selector">
              ...
              <button
                ...
                disabled={
                  isSavingInterval ||
                  selectedInterval === settings?.recordingIntervalMinutes
                }
            ...
            {settings && (
              <div className="service-status">
                ...
                <div className="status-item">
                  ...
                  <span className="status-value">
                    {new Date(settings.lastUpdated).toLocaleString()} by{" "}
                    {settings.updatedBy}
                  </span>
                </div>
              </div>
          ...
          <div className="management-section data-section">
              ...
              <div className="statistics-grid">
                <div className="stat-card">
                  ...
                  <div className="stat-value">
                    {statistics.totalReadings.toLocaleString()}
                  </div>
            ...
            <div className="operation-box">
              ...
              <p>
                Create 30 days of historical readings for all buildings (720
                readings per building). Useful for testing charts and demos.
              </p>
              <button
              ...
              {seedMessage && (
                <div
                  className={`message ${seedMessage.startsWith("✅") ? "success" : "error"}`}
                >
                  {seedMessage}
                </div>
              )}
            ...
            <div className="operation-box">
              <h3>📥 Export Data</h3>
              <p>
                Download all historical data as CSV file for analysis in Excel
                or other tools.
              </p>
              <button
                onClick={handleExportCsv}
                disabled={
                  isExporting || !statistics || statistics.totalReadings === 0
                }
              ...
              {exportMessage && (
                <div
                  className={`message ${exportMessage.startsWith("✅") ? "success" : "error"}`}
                >
                  {exportMessage}
                </div>
              )}
            ...
            <div className="operation-box danger-box">
              <h3>⚠️ Danger Zone</h3>
              <p>
                <strong>Clear All Historical Data:</strong> This action will
              ...
              <button
                ...
                disabled={
                  isClearing || !statistics || statistics.totalReadings === 0
                }
              ...
              {clearMessage && (
                <div
                  className={`message ${clearMessage.startsWith("✅") ? "success" : "error"}`}
                >
                  {clearMessage}
                </div>
              )}
          ...
          <div className="info-note">
            <p>
              💡 <strong>Note:</strong> The background service automatically
              records new data at the configured interval. Test data generation
              and export features are for demonstration and analysis purposes.
            </p>
          </div>
        </div>
      </div>
