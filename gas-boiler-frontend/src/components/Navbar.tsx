      ...
      <ul className="navbar-links">
        {user.role === "Admin" ? (
          <>
            ...
            <li>
              <Link to="/my-boilers">Boilers</Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/alarm-settings">Alarm Settings</Link>
            </li>
            <li>
              <Link to="/admin/system-parameters">Parameters</Link>
            </li>
            <li>
          ...
          <>
            ...
            <li>
              <Link to="/my-boilers">My Boilers</Link>
            </li>
            <li>
